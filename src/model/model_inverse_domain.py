    ...
    def train_step(self, beta=10, bilinear_params_dict=None):
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            cells_residual = self.loss_function(test_shape_val_mat = self.pre_multiplier_val, test_grad_x_mat = self.pre_multiplier_grad_x, \
                                ...
                                forcing_function = self.force_matrix, bilinear_params = bilinear_params_dict, inverse_params_list = [inverse_param_values])
        ...
        return {"loss_pde": total_pde_loss, "loss_dirichlet": boundary_loss, "loss": total_loss,"sensor_loss": sensor_loss}
