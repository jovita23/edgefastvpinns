...
import numpy as np
# import meshio
from .FE2D_Cell_SVD import FE2D_Cell_SVD
...
# from src.utils.print_utils import print_table
from src.utils.edge_utils import print_table_edge
...
class Fespace2DSVD:
    ...
    def __init__(self, mesh, cells, boundary_points, cell_type: str, fe_order: int, fe_type: str, quad_order: int, quad_type: str, fe_transformation_type: str,  \
                    bound_function_dict: dict, bound_condition_dict: dict, forcing_function, output_path: str, generate_mesh_plot: bool, 
                    svd_rank: int) -> None:
        """
    ...
    def set_finite_elements(self) -> None:
        ...
        for i in range(self.n_cells):
            self.fe_cell.append(FE2D_Cell_SVD(self.cells[i], self.cell_type, self.fe_order, self.fe_type, self.quad_order, self.quad_type, self.fe_transformation_type, self.forcing_function, \
                                                self.svd_rank))
        ...
        # print the values of List in a table format
        print_table_edge(title = "FE Space Information", column_headers = ["Property", "Value"], column1=title, column2=values)
    ...
    def get_shape_function_U(self, cell_index) -> np.ndarray:
        """
        This function will return the shape function actual values on a given cell
        """
        if(cell_index > self.n_cells):
        ...
        return self.fe_cell[cell_index].U_basis_reduced
    
    def get_shape_function_VT(self, cell_index) -> np.ndarray:
        """
        This function will return the shape function actual values on a given cell
        """
        if(cell_index > self.n_cells):
        ...
        return self.fe_cell[cell_index].VT_basis_reduced
    
    def get_shape_function_grad_x_U(self, cell_index) -> np.ndarray:
        """
        This function will return the shape function actual values on a given cell
        """
        if(cell_index > self.n_cells):
        ...
        return self.fe_cell[cell_index].U_gradx_reduced

    def get_shape_function_grad_x_VT(self, cell_index) -> np.ndarray:
        """
        This function will return the shape function actual values on a given cell
        """
        if(cell_index > self.n_cells):
        ...
        return self.fe_cell[cell_index].VT_gradx_reduced
    
    def get_shape_function_grad_y_U(self, cell_index) -> np.ndarray:
        """
        This function will return the shape function actual values on a given cell
        """
        if(cell_index > self.n_cells):
        ...
        return self.fe_cell[cell_index].U_grady_reduced
    
    def get_shape_function_grad_y_VT(self, cell_index) -> np.ndarray:
        """
        This function will return the shape function actual values on a given cell
        """
        if(cell_index > self.n_cells):
        ...
        return self.fe_cell[cell_index].VT_grady_reduced
    ...
    def get_sensor_data(self, exact_solution, num_points):
        ...
        points = np.linspace(0,1,num_internal_points)
...
class DecomposedFespace2D(Fespace2DSVD):
    """
