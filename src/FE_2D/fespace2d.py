...
class Fespace2D:
    ...
    def __init__(self, mesh, cells, boundary_points, cell_type: str, fe_order: int, fe_type: str, quad_order: int, quad_type: str, fe_transformation_type: str,  \
                    bound_function_dict: dict, bound_condition_dict: dict, forcing_function, output_path: str, generate_mesh_plot: bool = False) -> None:
        """
    ...
    def get_shape_function_val(self, cell_index) -> np.ndarray:
        ...
        return self.fe_cell[cell_index].basis_at_quad
    ...
    def get_shape_function_grad_x(self, cell_index) -> np.ndarray:
        ...
        return self.fe_cell[cell_index].basis_gradx_at_quad
    ...
    def get_shape_function_grad_x_ref(self, cell_index) -> np.ndarray:
        ...
        return self.fe_cell[cell_index].basis_gradx_at_quad_ref
    ...
    def get_shape_function_grad_y(self, cell_index) -> np.ndarray:
        ...
        return self.fe_cell[cell_index].basis_grady_at_quad
    ...
    def get_shape_function_grad_y_ref(self, cell_index) -> np.ndarray:
        ...
        return self.fe_cell[cell_index].basis_grady_at_quad_ref
    ...
    def get_sensor_data(self, exact_solution, num_points):
        ...
        # save the sensor points to a npz file
        np.savez(str(Path(self.output_path) / "sensor_points.npz"), points=points, exact_sol=exact_sol)
