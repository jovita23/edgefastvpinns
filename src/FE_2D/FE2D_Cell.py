...
class FE2D_Cell:
    ...
    """
    def __init__(self, cell_coordinates: np.ndarray, cell_type: str, fe_order: int, fe_type: str, quad_order: int, quad_type: str, fe_transformation_type: str, forcing_function):
