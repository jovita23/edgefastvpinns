...
class Basis2DQN(BasisFunction2D):
    ...
    def value(self, xi, eta):
        ...
        for i in range(num_shape_func_in_1d):
            values[i*num_shape_func_in_1d:(i+1)*num_shape_func_in_1d, :] = test_function_x[i, :] * test_function_y
    ...
    def gradx(self, xi, eta):
        ...
        # Generate an outer product of the test functions to generate the basis functions
        for i in range(num_shape_func_in_1d):
            values[i*num_shape_func_in_1d:(i+1)*num_shape_func_in_1d, :] = test_function_grad_x[i, :] * test_function_y
    ...
    def grady(self, xi, eta):
        ...
        # Generate an outer product of the test functions to generate the basis functions
        for i in range(num_shape_func_in_1d):
            values[i*num_shape_func_in_1d:(i+1)*num_shape_func_in_1d, :] = test_function_x[i, :] * test_function_grad_y
    ...
    def gradxx(self, xi, eta):
        ...
        # Generate an outer product of the test functions to generate the basis functions
        for i in range(num_shape_func_in_1d):
            values[i*num_shape_func_in_1d:(i+1)*num_shape_func_in_1d, :] = test_function_grad_grad_x[i, :] * test_function_y
    ...
    def gradxy(self, xi, eta):
        ...
        # Generate an outer product of the test functions to generate the basis functions
        for i in range(num_shape_func_in_1d):
            values[i*num_shape_func_in_1d:(i+1)*num_shape_func_in_1d, :] = test_function_grad_x[i, :] * test_function_grad_y
    ...
    def gradyy(self, xi, eta):
        ...
        # Generate an outer product of the test functions to generate the basis functions
        for i in range(num_shape_func_in_1d):
            values[i*num_shape_func_in_1d:(i+1)*num_shape_func_in_1d, :] = test_function_x[i, :] * test_function_grad_grad_y
