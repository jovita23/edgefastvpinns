...
@tf.function
def pde_loss_cd2d(test_shape_val_mat, test_grad_x_mat, test_grad_y_mat, pred_nn, pred_grad_x_nn, \
                pred_grad_y_nn, forcing_function, bilinear_params_dict, inverse_param_dict):
    """
