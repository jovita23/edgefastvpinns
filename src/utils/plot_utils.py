...
def plot_multiple_loss_function(loss_function_list, output_path, filename,  legend_labels, y_label, title, x_label="Epochs"):
    """
...
def plot_inverse_param_function(inverse_predicted, inverse_param_name, actual_value, output_path, file_prefix):
    """
    This function will plot the loss function
    """
    # plot the loss function
    ...
    plt.hlines(actual_value, 0, len(inverse_predicted), colors='k', linestyles='dashed', label=f'Actual ' + inverse_param_name)
