...
from src.model.model_hard_edge_svd import *

# import the example file
from examples.sin_cos import *

#import physics for custom loss function
from src.physics.poisson2d_svd import *
...
if __name__ == "__main__":
    ...
    fespace = Fespace2DSVD(mesh = domain.mesh, cells=cells, boundary_points=boundary_points, 
                        ...
                        forcing_function=rhs, output_path=i_output_path, generate_mesh_plot = i_generate_mesh_plot, svd_rank = i_fe_order**2 - 10)
    ...
    model = DenseModelEdgeSVD(layer_dims = i_model_architecture, learning_rate_dict = i_learning_rate_dict, \
                       params_dict = params_dict, \
                       loss_function = pde_loss_poisson_svd, input_tensors_list = [datahandler.x_pde_list, train_dirichlet_input, train_dirichlet_output], \
                        ...
                        tensor_dtype = i_dtype, print_verbose = i_print_verbose,
