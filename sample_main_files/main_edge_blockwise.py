...
from src.model.model_edge_blockwise import *
...
if __name__ == "__main__":
    ...
    datahandler = DataHandler2D(fespace, domain, i_num_blocks, i_rank_list, dtype=i_dtype)
    ...
    model = DenseModelEdge(layer_dims = i_model_architecture, learning_rate_dict = i_learning_rate_dict, \
                       ...
                       loss_function = pde_loss_poisson, input_tensors_list = [datahandler.x_pde_blocks, train_dirichlet_input, train_dirichlet_output], \
